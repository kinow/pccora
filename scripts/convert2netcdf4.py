...
def convert2netcdf4(data, file):
    ...
    dataset.exclude_loran_transmitters = str(
        ident['exclude_loran_transmitters']) + ', comment: One bit for each in the chain; and chain 2 transmitted'
    dataset.phase_integration_time = str(
        ident['phase_integration_time']) + ', comment: 0 = time (s) 1 = Altitude (m/MSI'
    ...
    # significance_key
    significance_key_variable = dataset.createVariable('significance_key', 'i1', ("time",), zlib=True,
                                                       fill_value=-32768)
    ...
    # significance_key
    recalculated_significance_key_variable = dataset.createVariable('recalculated_significance_key', 'f4', ("time",),
                                                                    zlib=True, fill_value=-32768)
